...
#  define hmalloc(size) debug_hmalloc(size, __FILE__, __LINE__)
#  define hcalloc(n,size) debug_hcalloc(n, size, __FILE__, __LINE__)
#  define hfree(ptr) debug_hfree(ptr, __FILE__, __LINE__)
#  define hrealloc(ptr,size) debug_hrealloc(ptr,size, __FILE__, __LINE__)
#  define hstrdup(src) debug_hstrdup(src, __FILE__, __LINE__)
...
void *debug_hrealloc(void *old_blk, size_t size, char *pcFile, int iLine);
